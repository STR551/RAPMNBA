        ...
        for line in file:
            ...
            if start == 1 and line != '</tr>\n' and line != '<tr>\n':
                ...
                if line.startswith("<td>") and line[4].isnumeric():
                    ...
                    team1NewScore = int(s[0])
                    team2NewScore = int(s[1])
                    ...
                    team1pd = team1NewScore - team1lastSubScore
                    team2pd = team2NewScore - team2lastSubScore
                    ...
                    team1Score = team1NewScore
                    team2Score = team2NewScore

                    lastSubScore = newScore
                    lastSubOff = newScoreOff
                    lastSubDef = newScoreDef

                    team1lastSubScore = team1NewScore
                    team2lastSubScore = team2NewScore


                    getDataPoint(pD,pList,time,team1pd,team2pd)
                    for p in pList:
                    ...
                    team1pd = team1Score - team1lastSubScore
                    team2pd = team2Score - team2lastSubScore
                    ...
                    getDataPoint(pD,pList,startTime,team1pd,team2pd)
...
def getDataPoint(pD,pList,startTime,team1pd,team2pd):
    pString = ""
    t = ""
    if startTime != 0:
        for p in pList:
        ...
        pString += str(team1pd)+","+str(startTime)+"\n"
    ...
    if startTime != 0:
        ...
        pString += str(team2pd)+","+str(startTime)+"\n"
        saveFile.write(pString)
